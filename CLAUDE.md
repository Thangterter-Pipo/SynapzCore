...
This project is indexed by GitNexus as **AGT_Brain** (6164 symbols, 10984 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
